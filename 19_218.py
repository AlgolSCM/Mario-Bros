...
def changetool(herramienta):
    aliados[keysdowns.index(True)].tool=herramientas[herramienta]
...
Uciaproducciones=[[['W A X M  BWWWWWWWWWWWWWW'
                    ,'W  AA   T   WBB  W '
                    ,'W   AAA   BB   W     W '
                    ,'W           W  AA   '
                    ,'W           W  BB   '
...
def actualmaze(independent,m,x=0,y=0):
    for row in independent:#Pasa por todas as posiciones para crear una lista de walls
        for col in row:
            ...
            elif col=="B":obstaculitos[m].append(obstaculo(x,y,2,'blue.jpeg'))
            ...
            elif col=="I":aliadosfree[m].append(allies(x,y,64,64,[0,64],'toad','fantasmita2.png','fantasmita2.png',herramientas[1],'Estatico','askmark.png'))            
