...
char = pygame.image.load('Mario 2.png')
...
##        returning(volviendo a Mario), recovering(llenan vida),mapa(estáticos)
        self.tiempo=0
    def siguiendo(self):
        self.rect.x=player.x+self.distance[0]
        self.rect.y=player.y+self.distance[1]
...
ene=[enemy(32,64,64,64,2,-2,3,'hola.png'),enemy(128,64,64,64,4,-1,3,'hola.png'),enemy(128,64,64,64,4,-1,3,'hola.png')]##(self,x,y,fin,width,height,vel,moved,vidas,imagen)
walls = []
level = [[
...
#            elif col=="A":Wall((x, y),m,mstartpoints,-1,(y,x))
